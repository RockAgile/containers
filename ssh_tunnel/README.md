Thanks to Cagatay Gurturk who provided the original version of [this]((https://github.com/cagataygurturk/docker-ssh-tunnel) that I then modified
...
```
    ...
    services:
      mysql:
        image: rockagile/docker-ssh-tunnel:0.0.1
        volumes:
